                        ...
                        <div class="card-body p-5">
                            <form method="post" action="procesar_marca.php?id=<?php echo $proveedorID; ?>">
                                <h3 class="text-center indigo-text font-bold py-4 fw-bold text-uppercase">
                                    <strong style="color: #fff">Agregar Marca</strong>
                                </h3>
                                <div class="mb-4">
                                    <div class="d-flex flex-nowrap">
                                        ...
                                        <div data-mdb-input-init class="order-1 form-outline form-white">
                                            ...
                                            <input type="text" id="nombre_marca" class="form-control form-control-lg"
                                                name="nombre_marca" required />
                                            <label class="form-label" for="nombre_marca">Nombre de la marca</label>
                                        </div>
                                    </div>
                                </div>
