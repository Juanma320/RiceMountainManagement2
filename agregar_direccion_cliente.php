...
if (isset($_GET['clienteID'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $message = $resultadoInsert ? "Dirección agregada con éxito." : "Error al agregar la dirección.";
    }
...
<body class="gradient-custom-1">
    ...
    <div class="mx-4 my-4">
        <a class="btn text-white btn-lg btn-floating" data-mdb-ripple-init style="background-color: #ac2bac;"
            role="button" onclick="window.location.href='direccionescliente.php?clienteID=<?php echo $clienteID; ?>'">
                        ...
                        <div class="card-body p-5">
                            <form action="" method="post">
                                <h3 class="text-center indigo-text font-bold py-4 fw-bold text-uppercase">
                                    <strong style="color: #fff">Agregar Dirección</strong>
                                </h3>
                                <div class="mb-4">
                                    <div class="d-flex flex-nowrap">
                                        <div class="order-0 col-md-1 d-flex align-items-center">
                                            <i class="fa-solid fa-map-location-dot prefix white-text"
                                                style="color: #fff"></i>
                                        </div>
                                ...
                                <div class="mb-4">
                                    <div class="d-flex flex-nowrap">
                                        <div class="order-0 col-md-1 d-flex align-items-center">
                                            <i class="fas fa-city prefix white-text" style="color: #fff"></i>
                                        </div>
                                        <div data-mdb-input-init class="order-1 form-outline form-white">
                                ...
                                <div class="mb-4">
                                    <div class="d-flex flex-nowrap">
                                        <div class="order-0 col-md-1 d-flex align-items-center">
                                            <i class="fas fa-signs-post prefix white-text" style="color: #fff"></i>
                                        </div>
                                        <div data-mdb-input-init class="order-1 form-outline form-white">
                                            <input type="text" id="codigoPostal" class="form-control form-control-lg"
                                ...
                                <div class="d-flex flex-row-reverse justify-content-center">
                                    <div class="order-0 p-2">
                                        <button data-mdb-ripple-init type="submit" class="btn btn-light">
                                            <i class="fa-solid fa-location-crosshairs pe-2"></i>Agregar
                                            Dirección</button>
                                    </div>
                                    <div class="order-1 p-2">
                                        <button data-mdb-ripple-init type="button" class="btn btn-danger"
                                            onclick="window.location.href='direccionescliente.php?clienteID=<?php echo $clienteID; ?>'">
