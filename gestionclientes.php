            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <ul class="nav nav-pills flex-column flex-md-row">
                        <li class="nav-item">
                            <a href="agregarcliente.php" style="color: #F9F6EE">
                                <button data-mdb-ripple-init type="button" class="btn btn-primary btn-rounded">
                                    <i class="fas fa-user pe-2"></i>Agregar cliente</button>
                            </a>
                        </li>
                    </ul>
                            ...
                            <table class="table table-striped table-responsive rounded-9 overflow-hidden table-hover"
                                ...
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th class="text-center">Modificar Cliente</th>
                                ...
                                while ($rowCliente = mysqli_fetch_assoc($resultClientes)) {
                                    ...
                                    echo "<td><a class='text-center'><a data-mdb-ripple-init class='btn btn-primary' href='agregardireccion.php?clienteID={$rowCliente['ClienteID']}'>Agregar</a></td>";
                                    echo "</tr>";
                                }
                                ?>
                            </table>
